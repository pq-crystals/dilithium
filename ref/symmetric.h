...
#define dilithium_aes256ctr_init NAMESPACE(dilithium_aes256ctr_init)
...
#define dilithium_shake128_stream_init NAMESPACE(dilithium_shake128_stream_init)
void dilithium_shake128_stream_init(keccak_state *state,
                                    const uint8_t seed[SEEDBYTES],
                                    uint16_t nonce);

#define dilithium_shake256_stream_init NAMESPACE(dilithium_shake256_stream_init)
