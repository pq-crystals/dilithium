...
#define cdecl(s) _cdecl(FIPS202X4_NAMESPACE(_##s))
#else
#define cdecl(s) FIPS202X4_NAMESPACE(_##s)
#endif
...
#define f1600x4 FIPS202X4_NAMESPACE(_f1600x4)
void f1600x4(__m256i *s, const uint64_t *rc);

#define shake128x4_absorb_once FIPS202X4_NAMESPACE(_shake128x4_absorb_once)
...
#define shake256x4_absorb_once FIPS202X4_NAMESPACE(_shake256x4_absorb_once)
